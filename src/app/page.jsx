...
export default function Home() {
  let vid = createRef();
  let [bgVidPlaying, setBgVidPlaying] = useState(false);

  let bg = bgVidPlaying ? "" : "bg-gradient-to-b from-cyan-600 to-cyan-800";
  return (
    <>
      <Navbar className="z-10" />
      <main className="flex min-h-screen flex-col items-center justify-between min-w-100 " onClick={()=> {setBgVidPlaying(true)}}>
        ...
        <div className={`flex ${bg} w-full flex-col items-center justify-center place-content-center min-w-full min-h-screen  xl:h-full text-white relative`} >
        <div className="bg-video">
          ...
          {bgVidPlaying ? "" : <p className="text-xs w-1/2 sm:w-full sm:text-sm text-center">Protip: kliknij gdziekolwiek, aby włączyć ruszające się tło :D</p>}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 auto-rows-max max-w-full text-center md:text-left my-10">
              ...
              <div className="relative grid-item h-52 w-full p-3 col-span-1 sm:col-span-2 text-center bg-zinc-900/60">
                ...
                <p className="relative text-violet-200 sm:p-3 whitespace-break-spaces text-md md:text-sm">
                  Oparty na swych dwóch poprzednikach, jego początki sięgają 2015 roku, pozwala Ci słuchać muzyki, którą sam dla Ciebie przygotowałem!
                  <br/>
                  Znajduje się w menu ;)
                  <br/><br/>  
                  </p>
